# Build a small neural network using numpy. Ex: Coffee roasting
import numpy as np
...
# Building a "dense layer" subroutine
...
# Try this routine on two examples
X_tst = np.array([
...
# Apply a threshold (here 0.5) to convert the probabilities to a decision
